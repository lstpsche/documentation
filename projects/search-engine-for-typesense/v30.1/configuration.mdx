...
Related: <a href="/projects/search-engine-for-typesense/v30.1/installation">Installation</a>, <a href="/projects/search-engine-for-typesense/v30.1/client">Client</a>, <a href="/projects/search-engine-for-typesense/v30.1/cli">CLI</a>
...
| `strict_fields`    | Boolean              | `true` in development/test; else `false` | Parser validates unknown fields when `true`; see <a href="/projects/search-engine-for-typesense/v30.1/query-dsl#error-reference">Query DSL</a> |
...
See <a href="/projects/search-engine-for-typesense/v30.1/observability">Observability</a> for event payloads and redaction.
...
Settings for vector search auto-embedding. See <a href="/projects/search-engine-for-typesense/v30.1/vector-search">Vector Search</a> for the full guide.
