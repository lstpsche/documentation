...
Related: <a href="/projects/search-engine-for-typesense/v30.1/models">Models</a>, <a href="/projects/search-engine-for-typesense/v30.1/indexer">Indexer</a>, <a href="/projects/search-engine-for-typesense/v30.1/deletion">Deletion</a>, <a href="/projects/search-engine-for-typesense/v30.1/client">Client</a>
...
- Upserts call your SearchEngine model: <code>SearchEngine::&lt;Model&gt;.upsert(record: ...)</code> using your mapping (see <a href="/projects/search-engine-for-typesense/v30.1/indexer">Indexer</a> and <a href="/projects/search-engine-for-typesense/v30.1/models">Models</a>).
...
- Target collection resolution prefers alias → physical mapping when available (see <a href="/projects/search-engine-for-typesense/v30.1/schema">Schema</a>).
...
- "Upsert skipped: no SearchEngine model": create a SearchEngine model and mapping for the collection; see <a href="/projects/search-engine-for-typesense/v30.1/models">Models</a> and <a href="/projects/search-engine-for-typesense/v30.1/indexer">Indexer</a>.
...
- Upserting helpers: <a href="/projects/search-engine-for-typesense/v30.1/upsert">Upsert</a>
- Deletion helpers: <a href="/projects/search-engine-for-typesense/v30.1/deletion">Deletion</a>
- Client wrapper: <a href="/projects/search-engine-for-typesense/v30.1/client">Client</a>
