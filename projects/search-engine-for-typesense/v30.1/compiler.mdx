...
Related: <a href="/projects/search-engine-for-typesense/v30.1/v30.1/query-dsl">Query DSL</a>, <a href="/projects/search-engine-for-typesense/v30.1/v30.1/relation">Relation</a>, <a href="/projects/search-engine-for-typesense/v30.1/v30.1/debugging">Debugging</a>

<Info>
  Instrumentation: <code>search_engine.compile</code> is emitted by the compiler. See <a href="/projects/search-engine-for-typesense/v30.1/v30.1/debugging">Debugging</a>.
</Info>
...
- Curation state maps to body params: <code>pinned_hits</code>, <code>hidden_hits</code>, <code>curation_tags</code>, <code>filter_curated_hits</code> (omitted when empty/<code>nil</code>). See <a href="/projects/search-engine-for-typesense/v30.1/v30.1/curation">Curation</a>.
...
<Info>
  The <code>:_join</code> section is an internal context map for downstream components and may be removed by the HTTP layer before sending the request. See <a href="/projects/search-engine-for-typesense/v30.1/v30.1/joins">Joins</a> for details.
</Info>

See also: <a href="/projects/search-engine-for-typesense/v30.1/v30.1/dx#helpers--examples">DX</a> for <code>Relation#to_params_json</code> — it uses <code>SearchEngine::CompiledParams</code> to ensure stable ordering.

See also: <a href="/projects/search-engine-for-typesense/v30.1/v30.1/relation">Relation</a> · <a href="/projects/search-engine-for-typesense/v30.1/v30.1/query-dsl">Query DSL</a> · <a href="/projects/search-engine-for-typesense/v30.1/v30.1/joins">Joins</a>
...
Backlinks: <a href="https://github.com/lstpsche/search-engine-for-typesense#readme" target="_blank">README</a>, <a href="/projects/search-engine-for-typesense/v30.1/v30.1/query-dsl">Query DSL</a>
