...
- <a href="/projects/search-engine-for-typesense/v30.1/troubleshooting">Troubleshooting</a>
...
- See <a href="/projects/search-engine-for-typesense/v30.1/indexer">Indexer</a> for mapping
  options and batch tuning.
- Use <a href="/projects/search-engine-for-typesense/v30.1/observability">Observability</a>
  to monitor rebuilds.
