---
title: "Curation"
description: "Pin or hide hits by ID, attach curation tags, and optionally filter hidden hits from the materialized view."
---

Related: <a href="/projects/search-engine-for-typesense/v30.1/v30.1/observability#logging">Observability</a>, <a href="/projects/search-engine-for-typesense/v30.1/v30.1/troubleshooting#curation">Troubleshooting → Curation</a>
...
- <code>curate(pin: [], hide: [], curation_tags: [], filter_curated_hits: nil|true|false)</code> — replace provided keys; omit to retain
...
- <code>curation_tags: Array&lt;String&gt;</code>
...
| Rule | Behavior |
| --- | --- |
| ID format | <code>SearchEngine.config.curation.id_regex</code> (default <code>/\A[\w\-:\.]+\z/</code>) applied to curated IDs and curation tags |
...
See also: <a href="/projects/search-engine-for-typesense/v30.1/multi-search#curation-in-multi-search">Multi‑search</a>
...
- <code>search_engine.curation.compile</code> — once per compile when curation state exists
  - Payload: <code>pinned_count</code>, <code>hidden_count</code>, <code>has_curation_tags</code>, <code>filter_curated_hits</code>
