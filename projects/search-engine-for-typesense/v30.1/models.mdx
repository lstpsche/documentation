...
Related: <a href="/projects/search-engine-for-typesense/v30.1/relation">Relation</a>, <a href="/projects/search-engine-for-typesense/v30.1/materializers">Materializers</a>, <a href="/projects/search-engine-for-typesense/v30.1/upsert">Upsert</a>
...
<Warning>
  ...
  See <a href="/projects/search-engine-for-typesense/v30.1/troubleshooting">Troubleshooting</a> for
...
Backlinks: <a href="/projects/search-engine-for-typesense/v30.1/indexer">Indexer</a>, <a href="/projects/search-engine-for-typesense/v30.1/schema">Schema</a>
...
- See also: <a href="/projects/search-engine-for-typesense/v30.1/relation">Relation</a>, <a href="/projects/search-engine-for-typesense/v30.1/materializers">Materializers</a>
...
See details and examples in <a href="/projects/search-engine-for-typesense/v30.1/joins#instance-association-readers-ar-like-hop">Joins</a>.
...
See also: <a href="/projects/search-engine-for-typesense/v30.1/materializers">Materializers</a>.
...
See also: <a href="/projects/search-engine-for-typesense/v30.1/relation">Relation</a>.
...
Backlinks: <a href="/projects/search-engine-for-typesense/v30.1/schema">Schema</a>, <a href="/projects/search-engine-for-typesense/v30.1/index">Home</a>
...
Backlinks: <a href="/projects/search-engine-for-typesense/v30.1/configuration">Configuration</a>, <a href="/projects/search-engine-for-typesense/v30.1/relation">Relation</a>
...
- <code>index: true|false</code> — when <code>false</code>, the field is generally omitted from the compiled Typesense schema. You may still send the field in documents; Typesense stores it and returns it with hits, but it is not indexed in memory. Nested subfields under an unindexed base object are also omitted. **Exception:** fields referenced by an embedding's <code>from:</code> list are kept in the compiled schema with Typesense-native <code>"index": false</code> and <code>"optional": true</code>, so the embedding model can read their values without keyword-indexing them.
...
See also how these options appear in the compiled schema and diffs in <a href="/projects/search-engine-for-typesense/v30.1/schema">Schema</a> (keys: <code>locale</code>, <code>sort</code>, <code>optional</code>, <code>infix</code>).

### Embedding fields (vector search)

Use the `embedding` macro to declare auto-embedding or external-embedding vector fields. The macro registers a `:vector` attribute internally and builds the Typesense `embed` block at schema compile time.
...
See <a href="/projects/search-engine-for-typesense/v30.1/vector-search">Vector Search</a> for all `embedding` forms, name resolution rules, configuration, and query DSL.
...
Backlinks: <a href="/projects/search-engine-for-typesense/v30.1/schema">Schema</a>, <a href="/projects/search-engine-for-typesense/v30.1/field-selection">Field Selection</a>, <a href="/projects/search-engine-for-typesense/v30.1/indexer">Indexer</a>
