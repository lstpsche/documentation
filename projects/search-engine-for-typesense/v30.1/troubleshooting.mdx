...
- Orphaned physical collections accumulating
  - Since v30.1.6.14, failed/interrupted applies auto-clean the new physical. For older orphans, run <code>SearchEngine::Schema.prune_orphans!</code> or <code>rails 'search_engine:schema:prune_orphans'</code>
  - See
