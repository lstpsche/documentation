...
Related: <a href="/projects/search-engine-for-typesense/v30.1/schema">Schema</a>, <a href="/projects/search-engine-for-typesense/v30.1/cli">CLI</a>, <a href="/projects/search-engine-for-typesense/v30.1/observability">Observability</a>, <a href="/projects/search-engine-for-typesense/v30.1/upsert">Upsert</a>
...
<code>docs_total</code>, <code>failed_total</code>, and <code>batches</code> array to ensure accurate reporting.

When indexation is run inside <code>Schema.apply!</code> (e.g., via <code>.index_collection</code>), a non-ok
result raises <code>SearchEngine::Errors::IndexationAborted</code>, which prevents the alias swap. The
partially-indexed new physical is left intact for inspection. See
<a href="/projects/search-engine-for-typesense/v30.1/schema#failed-indexation-safety">Schema → Failed indexation safety</a>.
...
<a href="/projects/search-engine-for-typesense/v30.1/observability#live-progress-tty">
Observability → Live progress (TTY)</a>.
...
<Warning>
  ...
  strategy. See
  <a href="/projects/search-engine-for-typesense/v30.1/models#document-identity-identify_by">Models</a>.
</Warning>
...
Backlinks: <a href="/projects/search-engine-for-typesense/v30.1/models">Models</a>, <a href="/projects/search-engine-for-typesense/v30.1/schema">Schema</a>
...
Backlinks: <a href="/projects/search-engine-for-typesense/v30.1/schema">Schema</a>, <a href="/projects/search-engine-for-typesense/v30.1/cli">CLI</a>, <a href="/projects/search-engine-for-typesense/v30.1/observability">Observability</a>
...
Backlinks: <a href="/projects/search-engine-for-typesense/v30.1/schema">Schema</a>, <a href="/projects/search-engine-for-typesense/v30.1/cli">CLI</a>, <a href="/projects/search-engine-for-typesense/v30.1/observability">Observability</a>, <a href="/projects/search-engine-for-typesense/v30.1/models">Models</a>
...
Backlinks: <a href="/projects/search-engine-for-typesense/v30.1/models">Models</a> · <a href="/projects/search-engine-for-typesense/v30.1/schema">Schema</a> · <a href="/projects/search-engine-for-typesense/v30.1/observability">Observability</a>

### Stale Deletes

Backlinks: <a href="/projects/search-engine-for-typesense/v30.1/cli">CLI</a>, <a href="/projects/search-engine-for-typesense/v30.1/observability">Observability</a>, <a href="/projects/search-engine-for-typesense/v30.1/troubleshooting">Troubleshooting</a>, <a href="/projects/search-engine-for-typesense/v30.1/configuration">Configuration</a>
...
See also: <a href="/projects/search-engine-for-typesense/v30.1/deletion">Deletion</a> for low-level helpers and <a href="/projects/search-engine-for-typesense/v30.1/observability">Observability</a> for emitted events.

### Dispatcher

Backlinks: <a href="/projects/search-engine-for-typesense/v30.1/cli">CLI</a>, <a href="/projects/search-engine-for-typesense/v30.1/observability">Observability</a>, <a href="/projects/search-engine-for-typesense/v30.1/configuration">Configuration</a>, <a href="https://guides.rubyonrails.org/active_job_basics.html" target="_blank">Jobs</a>
...
For light-touch updates or small repair batches, the model helpers described in <a href="/projects/search-engine-for-typesense/v30.1/upsert">Upsert</a>
...
Backlinks: <a href="/projects/search-engine-for-typesense/v30.1/cli">CLI</a>, <a href="/projects/search-engine-for-typesense/v30.1/troubleshooting">Troubleshooting</a>
