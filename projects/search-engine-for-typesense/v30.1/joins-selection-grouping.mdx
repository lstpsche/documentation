...
Related: <a href="/projects/search-engine-for-typesense/v30.1/joins">Joins</a>, <a href="/projects/search-engine-for-typesense/v30.1/relation-reference">Relation Guide</a>, <a href="/projects/search-engine-for-typesense/v30.1/grouping">Grouping</a>, <a href="/projects/search-engine-for-typesense/v30.1/field-selection">Field Selection</a>
...
- Keys auto‑resolve by default (see <a href="/projects/search-engine-for-typesense/v30.1/joins">Joins → Auto‑resolution</a>). Override for non‑standard schemas.
- Supported join usage: selection, filtering, and ordering on joined fields; grouping must target base fields only

See <a href="/projects/search-engine-for-typesense/v30.1/joins">Joins</a> and <a href="/projects/search-engine-for-typesense/v30.1/relation-reference">Relation Guide</a> for details.
...
See: <a href="/projects/search-engine-for-typesense/v30.1/field-selection">Field Selection</a>, <a href="/projects/search-engine-for-typesense/v30.1/relation-reference">Relation Guide</a>.
...
See: <a href="/projects/search-engine-for-typesense/v30.1/joins">Joins</a>, <a href="/projects/search-engine-for-typesense/v30.1/compiler">Compiler</a>, and <a href="/projects/search-engine-for-typesense/v30.1/relation-reference">Relation Guide</a>.
...
- Unknown association (e.g., <code>joins(:authrs)</code>): raises <code>InvalidJoin</code>
  ...
  - See: <a href="/projects/search-engine-for-typesense/v30.1/joins">Joins</a>
...
- Invalid grouping limit (e.g., <code>limit: 0</code>): raises <code>InvalidGroup</code>
  ...
  - See: <a href="/projects/search-engine-for-typesense/v30.1/grouping">Grouping</a>
...
Offline tests: enable the stub client and queue responses to exercise relations end‑to‑end with no external calls. See <a href="/projects/search-engine-for-typesense/v30.1/testing">Testing</a>.

See also: <a href="/projects/search-engine-for-typesense/v30.1/joins">Joins</a>, <a href="/projects/search-engine-for-typesense/v30.1/grouping">Grouping</a>.
...
See <a href="/projects/search-engine-for-typesense/v30.1/observability">Observability</a> for payload redaction and event payloads.
