...
Related: <a href="/projects/search-engine-for-typesense/v30.1/cli">CLI</a>, <a href="/projects/search-engine-for-typesense/v30.1/troubleshooting#schema">Troubleshooting → Schema</a>
...
When <code>Schema.apply!</code> is used with the high-level <code>.index_collection</code> flow, the engine
...
alias swap. The newly created physical collection is left intact for inspection.
...
Physical collections can accumulate when blue/green deployments fail before the alias swap occurs.
<code>Schema.prune_orphans!</code> scans all collections matching the timestamped naming pattern
(<code>logical_YYYYMMDD_HHMMSS_###</code>) and drops any that are not the target of an alias.
...
A rake task is also available (see <a href="/projects/search-engine-for-typesense/v30.1/cli#commands">CLI</a>):
...
See also: <a href="/projects/search-engine-for-typesense/v30.1/client">Client</a>, <a href="/projects/search-engine-for-typesense/v30.1/configuration">Configuration</a>, and <a href="/projects/search-engine-for-typesense/v30.1/compiler">Compiler</a>.
...
Backlinks: <a href="https://github.com/lstpsche/search-engine-for-typesense#readme" target="_blank">README</a>, <a href="/projects/search-engine-for-typesense/v30.1/indexer">Indexer</a>
