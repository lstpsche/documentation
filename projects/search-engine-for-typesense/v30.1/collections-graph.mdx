...
```mermaid
flowchart LR
  A["books"] -- "publisher_id -> id" --> B["publishers"]
  A -- "author_ids -> id" --> C["authors"]
```
...
<Columns cols={2}>
  <Card
    title="Schema"
    icon="brackets-curly"
    href="/projects/search-engine-for-typesense/v30.1/schema"
  >
  ...
  <Card
    title="Indexer"
    icon="cloud-arrow-up"
    href="/projects/search-engine-for-typesense/v30.1/indexer"
  >
  ...
  <Card
    title="Joins"
    icon="shuffle"
    href="/projects/search-engine-for-typesense/v30.1/joins"
  >
  ...
  <Card
    title="DX"
    icon="sparkles"
    href="/projects/search-engine-for-typesense/v30.1/dx"
  >
