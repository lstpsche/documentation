...
```md
Related: [Relation](/projects/search-engine-for-typesense/v29/relation), [DX](/projects/search-engine-for-typesense/v29/dx), [Observability](/projects/search-engine-for-typesense/v29/observability)
```
...
```md
See [Observability](/projects/search-engine-for-typesense/v29/observability).
```
...
```md
> Having trouble? See [Troubleshooting](/projects/search-engine-for-typesense/v29/troubleshooting) for fixes.
```
...
Related: <a href="/projects/search-engine-for-typesense/v29/index">Home</a>, <a href="https://github.com/lstpsche/search-engine-for-typesense#readme" target="_blank">Contribution guide</a>
