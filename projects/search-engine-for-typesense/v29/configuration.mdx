...
Related: <a href="/projects/search-engine-for-typesense/v29/installation">Installation</a>, <a href="/projects/search-engine-for-typesense/v29/client">Client</a>, <a href="/projects/search-engine-for-typesense/v29/cli">CLI</a>
...
| `strict_fields`    | Boolean              | `true` in development/test; else `false` | Parser validates unknown fields when `true`; see <a href="/projects/search-engine-for-typesense/v29/query-dsl#error-reference">Query DSL</a> |
...
See <a href="/projects/search-engine-for-typesense/v29/observability">Observability</a> for event payloads and redaction.
