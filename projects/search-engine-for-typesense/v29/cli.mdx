...
Related: <a href="/projects/search-engine-for-typesense/v29/tuit">TUIT</a>, <a href="/projects/search-engine-for-typesense/v29/troubleshooting#cli">Troubleshooting → CLI</a>, <a href="/projects/search-engine-for-typesense/v29/observability#opentelemetry">Observability → OpenTelemetry</a>
...
Backlinks: <a href="/projects/search-engine-for-typesense/v29/observability#opentelemetry">Observability → OpenTelemetry</a>, <a href="/projects/search-engine-for-typesense/v29/installation">Installation</a>, <a href="/projects/search-engine-for-typesense/v29/configuration">Configuration</a>

See also: <a href="/projects/search-engine-for-typesense/v29/configuration">Configuration</a> and <a href="/projects/search-engine-for-typesense/v29/observability#opentelemetry">Observability</a> for logging and OTel.
...
- Failed indexation during <code>schema:apply</code> prevents the alias swap; the new physical is left for inspection. See <a href="/projects/search-engine-for-typesense/v29/schema#failed-indexation-safety">Schema → Failed indexation safety</a>.

## See also

- <a href="/projects/search-engine-for-typesense/v29/schema">Schema</a> — compiler, diff, apply! and rollback
- <a href="/projects/search-engine-for-typesense/v29/indexer">Indexer</a> — import flow, dry-run, partitioning, dispatcher
