...
Related: <a href="/projects/search-engine-for-typesense/v29/client">Client</a>, <a href="/projects/search-engine-for-typesense/v29/compiler">Compiler</a>, <a href="/projects/search-engine-for-typesense/v29/observability">Observability</a>, <a href="/projects/search-engine-for-typesense/v29/dx">DX</a>

<Info>
  See also: <a href="/projects/search-engine-for-typesense/v29/debugging">Debugging & Explain</a> and <a href="/projects/search-engine-for-typesense/v29/dx">DX helpers</a>
</Info>
...
- <strong>select(*fields)</strong> / <strong>exclude(*fields)</strong> / <strong>reselect(*fields)</strong>: field selection DSL. See <a href="/projects/search-engine-for-typesense/v29/field-selection">Field Selection</a> and <a href="/projects/search-engine-for-typesense/v29/joins#nested-field-selection-for-joined-collections">JOINs</a>.
...
See <a href="/projects/search-engine-for-typesense/v29/materializers">Materializers</a> for execution methods (<code>to_a</code>, <code>each</code>, <code>first</code>, <code>last</code>, <code>take</code>, <code>pluck</code>, <code>ids</code>, <code>count</code>, <code>exists?</code>).
...
See also: <a href="/projects/search-engine-for-typesense/v29/compiler">Compiler</a>. See <a href="/projects/search-engine-for-typesense/v29/client">Client</a> for execution context.
...
<Note>
  For predicate parsing rules and AST details, see <a href="/projects/search-engine-for-typesense/v29/query-dsl">Query DSL</a>.
</Note>
...
- <strong>select(*fields)</strong>: accepts symbols/strings or arrays; trims and de-duplicates preserving first occurrence. If the model declares attributes, unknown fields raise. See <a href="/projects/search-engine-for-typesense/v29/field-selection">Field Selection</a>.
...
<Note>
  For compilation rules and parameter mapping, see <a href="/projects/search-engine-for-typesense/v29/compiler">Compiler</a> and <a href="/projects/search-engine-for-typesense/v29/debugging">Debugging</a>.
</Note>
