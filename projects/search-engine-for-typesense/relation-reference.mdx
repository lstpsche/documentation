...
Related: <a href="/projects/search-engine-for-typesense/relation">Relation</a>, <a href="/projects/search-engine-for-typesense/query-dsl">Query DSL</a>, <a href="/projects/search-engine-for-typesense/dx">DX</a>, <a href="/projects/search-engine-for-typesense/debugging">Debugging</a>
...
See also: <a href="/projects/search-engine-for-typesense/relation">Relation</a> and <a href="/projects/search-engine-for-typesense/query-dsl">Query DSL</a>.
...
- OR semantics require a raw fragment (e.g., "a:=1 || b:=2") or higher‑level AST usage (see <a href="/projects/search-engine-for-typesense/query-dsl">Query DSL</a>)
...
See: <a href="/projects/search-engine-for-typesense/dx">DX</a> to preview compiled params. NOT-IN is rendered as <code>NOT IN [...]</code> in explain output.
...
- <strong>Joins</strong>: Declare associations on the model, apply with <code>.joins(:assoc)</code>, then filter
  ...
  <a href="/projects/search-engine-for-typesense/joins">Joins</a> and
...
- <strong>Presets</strong>: Attach server‑side bundles of defaults and choose a mode
  ...
  <a href="/projects/search-engine-for-typesense/presets">Presets</a> and
...
See: <a href="/projects/search-engine-for-typesense/dx">DX</a>, <a href="/projects/search-engine-for-typesense/observability">Observability</a>.
...
See: <a href="/projects/search-engine-for-typesense/compiler">Compiler</a> for precedence, quoting rules, and join context.
...
- <strong>Quoting</strong>: strings are double‑quoted; booleans <code>true/false</code>; <code>nil</code> → <code>null</code>; arrays are one‑level
  ...
  numeric <code>:time/:datetime</code> fields prefer epoch seconds; <code>:time_string/:datetime_string</code> use ISO8601 (see <a href="/projects/search-engine-for-typesense/compiler">Compiler</a>).
- <strong>Booleans vs strings</strong>: boolean fields coerce "true"/"false"; other fields treat strings literally (see <a href="/projects/search-engine-for-typesense/joins">Joins</a>).
...
- <strong>Joined fields</strong>: require <code>.joins(:assoc)</code> before filtering/sorting/selection on <code>$assoc.field</code> (see <a href="/projects/search-engine-for-typesense/joins">Joins</a>).
- <strong>Grouping field</strong>: base fields only; joined paths like <code>$assoc.field</code> are rejected (see <a href="/projects/search-engine-for-typesense/grouping">Grouping</a>).
...
See <a href="/projects/search-engine-for-typesense/faceting">Faceting</a> for first-class faceting DSL: <code>facet_by</code>, <code>facet_query</code>, compiler mapping and result helpers.

---

Related links: <a href="/projects/search-engine-for-typesense/relation">Relation</a>, <a href="/projects/search-engine-for-typesense/query-dsl">Query DSL</a>, <a href="/projects/search-engine-for-typesense/dx">DX</a>,
<a href="/projects/search-engine-for-typesense/joins">Joins</a>, <a href="/projects/search-engine-for-typesense/field-selection">Field Selection</a>, <a href="/projects/search-engine-for-typesense/compiler">Compiler</a>,
<a href="/projects/search-engine-for-typesense/grouping">Grouping</a>, <a href="/projects/search-engine-for-typesense/observability">Observability</a>
