...
Related: <a href="/projects/search-engine-for-typesense/v30/relation">Relation</a>, <a href="/projects/search-engine-for-typesense/v30/compiler">Compiler</a>
...
<a href="/projects/search-engine-for-typesense/v30/relation">Relation</a>#where accepts Hash, raw String, and SQL‑ish fragment+args. The parser converts these inputs into AST nodes and stores them alongside legacy string filters. A later compiler pass will prefer AST when present.
...
- <code>Relation#to_typesense_params</code> compiles <code>relation.ast</code> via the <a href="/projects/search-engine-for-typesense/v30/compiler">Compiler</a> when present; otherwise falls back to legacy string <code>filters</code>.

See also: <a href="/projects/search-engine-for-typesense/v30/relation">Relation</a> · <a href="/projects/search-engine-for-typesense/v30/compiler">Compiler</a>

## Re‑chainers (reselect / rewhere / unscope)

See also: <a href="/projects/search-engine-for-typesense/v30/relation-reference">Relation Guide</a> · <a href="/projects/search-engine-for-typesense/v30/relation">Relation</a> · <a href="/projects/search-engine-for-typesense/v30/dx">DX</a>
...
See also: <a href="/projects/search-engine-for-typesense/v30/troubleshooting">Troubleshooting</a> · <a href="/projects/search-engine-for-typesense/v30/relation-reference">Relation Guide</a> · <a href="/projects/search-engine-for-typesense/v30/compiler">Compiler</a>
