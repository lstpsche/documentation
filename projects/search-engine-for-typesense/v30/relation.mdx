...
Related: <a href="/projects/search-engine-for-typesense/v30/client">Client</a>, <a href="/projects/search-engine-for-typesense/v30/compiler">Compiler</a>, <a href="/projects/search-engine-for-typesense/v30/observability">Observability</a>, <a href="/projects/search-engine-for-typesense/v30/dx">DX</a>

<Info>
  See also: <a href="/projects/search-engine-for-typesense/v30/debugging">Debugging & Explain</a> and <a href="/projects/search-engine-for-typesense/v30/dx">DX helpers</a>
</Info>
...
- <strong>select(*fields)</strong> / <strong>exclude(*fields)</strong> / <strong>reselect(*fields)</strong>: field selection DSL. See <a href="/projects/search-engine-for-typesense/v30/field-selection">Field Selection</a> and <a href="/projects/search-engine-for-typesense/v30/joins#nested-field-selection-for-joined-collections">JOINs</a>.
...
See <a href="/projects/search-engine-for-typesense/v30/materializers">Materializers</a> for execution methods (<code>to_a</code>, <code>each</code>, <code>first</code>, <code>last</code>, <code>take</code>, <code>pluck</code>, <code>ids</code>, <code>count</code>, <code>exists?</code>).
...
See also: <a href="/projects/search-engine-for-typesense/v30/compiler">Compiler</a>. See <a href="/projects/search-engine-for-typesense/v30/client">Client</a> for execution context.
...
<Note>
  For predicate parsing rules and AST details, see <a href="/projects/search-engine-for-typesense/v30/query-dsl">Query DSL</a>.
</Note>
...
- <strong>where_geo(field, within_radius: / within_polygon:)</strong>: geo filter by radius or polygon. See <a href="/projects/search-engine-for-typesense/v30/geo-search">Geo Search</a>.
- <strong>order_geo(field, from:, direction:)</strong>: sort by distance from a reference point. See <a href="/projects/search-engine-for-typesense/v30/geo-search">Geo Search</a>.
- <strong>order_eval(expression, direction:)</strong>: sort by a Typesense <code>_eval()</code> conditional expression. See <a href="/projects/search-engine-for-typesense/v30/geo-search">Geo Search</a>.
- <strong>select(*fields)</strong>: accepts symbols/strings or arrays; trims and de-duplicates preserving first occurrence. If the model declares attributes, unknown fields raise. See <a href="/projects/search-engine-for-typesense/v30/field-selection">Field Selection</a>.
...
<Note>
  For compilation rules and parameter mapping, see <a href="/projects/search-engine-for-typesense/v30/compiler">Compiler</a> and <a href="/projects/search-engine-for-typesense/v30/debugging">Debugging</a>.
</Note>
