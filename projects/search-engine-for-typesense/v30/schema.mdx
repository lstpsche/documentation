...
- <strong>Orphaned physicals accumulating</strong>: Since v30.6.14, failed or interrupted applies auto-delete the new physical. For older orphans, run <code>Schema.prune_orphans!</code> or the <code>schema:prune_orphans</code> task.
