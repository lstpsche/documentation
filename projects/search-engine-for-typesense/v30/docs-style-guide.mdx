...
```md
Related: [Relation](/projects/search-engine-for-typesense/v30/relation), [DX](/projects/search-engine-for-typesense/v30/dx), [Observability](/projects/search-engine-for-typesense/v30/observability)
```
...
```md
See [Observability](/projects/search-engine-for-typesense/v30/observability).
```
...
```md
> Having trouble? See [Troubleshooting](/projects/search-engine-for-typesense/v30/troubleshooting) for fixes.
```
...
Related: <a href="/projects/search-engine-for-typesense/v30/index">Home</a>, <a href="https://github.com/lstpsche/search-engine-for-typesense#readme" target="_blank">Contribution guide</a>
