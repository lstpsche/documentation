...
Related: <a href="/projects/search-engine-for-typesense/relation">Relation</a>, <a href="/projects/search-engine-for-typesense/materializers">Materializers</a>, <a href="/projects/search-engine-for-typesense/upsert">Upsert</a>
...
Every Typesense document must include a unique String <code>id</code>. The gem computes this automatically per record and injects it during indexing.
...
- **Precedence order**: When creating/upserting documents, the id is resolved as: (1) explicit <code>:id</code> attribute provided, (2) <code>identify_by</code> strategy result, (3) <code>record.id.to_s</code> fallback.
...
Backlinks: <a href="/projects/search-engine-for-typesense/indexer">Indexer</a>, <a href="/projects/search-engine-for-typesense/schema">Schema</a>
...
- See also: <a href="/projects/search-engine-for-typesense/relation">Relation</a>, <a href="/projects/search-engine-for-typesense/materializers">Materializers</a>

### Instance association readers (joins)

When you declare <code>belongs_to</code> or <code>has</code> on a model, an instance method with the same name is defined to resolve referenced records:

- <code>belongs_to :author</code> → <code>book.author</code> returns a single record or <code>nil</code>.
- <code>has :orders</code> → <code>book.orders</code> returns a chainable <code>Relation</code>.

See details and examples in <a href="/projects/search-engine-for-typesense/joins#instance-association-readers-ar-like-hop">Joins</a>.
...
See also: <a href="/projects/search-engine-for-typesense/materializers">Materializers</a>.
...
See also: <a href="/projects/search-engine-for-typesense/relation">Relation</a>.
...
Backlinks: <a href="/projects/search-engine-for-typesense/schema">Schema</a>, <a href="/projects/search-engine-for-typesense/index">Home</a>
...
Backlinks: <a href="/projects/search-engine-for-typesense/configuration">Configuration</a>, <a href="/projects/search-engine-for-typesense/relation">Relation</a>
...
See also how these options appear in the compiled schema and diffs in <a href="/projects/search-engine-for-typesense/schema">Schema</a> (keys: <code>locale</code>, <code>sort</code>, <code>optional</code>, <code>infix</code>).
...
Backlinks: <a href="/projects/search-engine-for-typesense/schema">Schema</a>, <a href="/projects/search-engine-for-typesense/field-selection">Field Selection</a>, <a href="/projects/search-engine-for-typesense/indexer">Indexer</a>
