...
- Missing or invalid association name
  - Ensure you declared it on the model with <code>belongs_to :name</code> or <code>has :name</code>
...
- <code>Model.cleanup</code> skipped
  - Ensure you declared <code>stale</code> rules inside <code>index</code>; otherwise cleanup logs a skip and returns <code>0</code>
