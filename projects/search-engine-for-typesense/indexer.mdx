...
<Warning>
  ...
  strategy. See
  <a href="/projects/search-engine-for-typesense/models#document-identity-identify_by">Models</a>.
</Warning>
...
SearchEngine::Product.cleanup
SearchEngine::Product.cleanup(partition: 42)
SearchEngine::Product.cleanup(into: "products_20251011_120000_001")
# Clear Typesense cache after cleanup
SearchEngine::Product.cleanup(clear_cache: true)
```
