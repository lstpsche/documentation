...
- See <a href="/projects/search-engine-for-typesense/dx">DX</a> for DX helpers (<code>to_params_json</code>, <code>dry_run!</code>, <code>explain</code>).
- See <a href="/projects/search-engine-for-typesense/relation-reference">Relation Guide</a> and <a href="/projects/search-engine-for-typesense/cookbook-queries">Cookbook Queries</a> for composing DSL calls.
- See <a href="/projects/search-engine-for-typesense/observability">Observability</a> for event names.
- Related: <a href="/projects/search-engine-for-typesense/faceting">Faceting</a> if you combine facets and highlighting.
