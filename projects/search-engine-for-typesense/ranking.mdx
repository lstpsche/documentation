...
See also: <a href="/projects/search-engine-for-typesense/dx">DX</a>, <a href="/projects/search-engine-for-typesense/relation-reference">Relation Guide</a>, and <a href="/projects/search-engine-for-typesense/cookbook-queries#recipes">Cookbook Queries</a>.
...
- Weight for unknown field:
  - Ensure the key exists in the effective `query_by` list; see <a href="/projects/search-engine-for-typesense/field-selection#dsl">Relation Guide → selection</a>
...
- <a href="/projects/search-engine-for-typesense/relation-reference">Relation Guide</a>
- <a href="/projects/search-engine-for-typesense/cookbook-queries">Cookbook Queries</a>
...
- <a href="/projects/search-engine-for-typesense/synonyms-stopwords">Synonyms & Stopwords</a>
