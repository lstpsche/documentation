...
- Declare associations on the model: <code>belongs_to :author</code> and <code>has :books</code> (override <code>collection:</code>, <code>local_key:</code>, <code>foreign_key:</code> when needed).
